  ...
  return (
    <>
      <div className="aspect-[10/7] md:aspect-auto overflow-hidden rounded-xl bg-skeleton shadow">
        {fixeds[0] ? (
          <Link href={fixeds[0].link ?? noLink} className="relative inline-block h-full w-full">
            <img
              className="object-cover w-full h-full"
      ...
      <div className="aspect-[10/7] md:aspect-auto overflow-hidden rounded-xl bg-skeleton shadow">
        {fixeds[1] ? (
          <Link href={fixeds[1].link ?? noLink} className="relative inline-block h-full w-full">
            <img
              className="object-cover w-full h-full"
